 ...
 * @author baolee baha
 */
@WebFilter(filterName = "AuthenFilters", urlPatterns = {"/*"})
public class AuthenFilters implements Filter {
    ...
    public AuthenFilters() {
        ...
        NON_AUTHEN_RESOURCE.add(".webp");
        NON_AUTHEN_RESOURCE.add("shopping.jsp");
        NON_AUTHEN_RESOURCE.add("createUser.jsp");
        NON_AUTHEN_RESOURCE.add("home.jsp");
        NON_AUTHEN_RESOURCE.add("forgotPassword.jsp");
        NON_AUTHEN_RESOURCE.add("viewCart.jsp");
        NON_AUTHEN_RESOURCE.add("orders.jsp");
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("AuthenFilters:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AuthenFilters:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("AuthenFilters:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("AuthenFilters()");
        }
        StringBuffer sb = new StringBuffer("AuthenFilters(");
